        ...
        <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
          ...
          <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              Marketing Analytics is the practice of using data, statistical models, and technology to measure, analyze, and optimize marketing strategies.
               It provides insights into customer behavior, campaign effectiveness, and market trends to inform decision-making.
              </p>
              <div className="mt-12 space-y-12">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    Marketing analytics leverages data from multiple channels, such as social media, websites, and CRM, to understand customer preferences. This enables businesses to identify patterns, segment audiences, 
                    and tailor marketing efforts effectively for better engagement and results.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    By analyzing key performance metrics, marketers can evaluate campaign performance in real-time. This allows for adjustments to strategies, 
                    such as reallocating budgets or refining messaging, ensuring maximum return on investment (ROI).
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    Marketing analytics supports predictive modeling to forecast future trends and customer behaviors. These insights empower businesses to make informed decisions,
                     anticipate market changes, and maintain a competitive edge in dynamic industries.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div>
            <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
              <div className="lg:col-start-2">
                ...
                <p className="mt-3 text-lg text-gray-600">
                Our Marketing Analysis solutions empower businesses to make data-driven decisions, enhance customer targeting, and optimize marketing strategies for increased ROI.
                 We leverage advanced analytics to provide actionable insights and measurable results.
                ...
                <div className="mt-12 space-y-12">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      We gather and analyze data from various sources, turning it into actionable insights. This helps businesses understand customer behavior, market trends, and campaign performance. With accurate data at their disposal, 
                      companies can refine their strategies to target the right audiences and improve their marketing ROI.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Our solutions enable businesses to segment their audience based on demographics, psychographics, and buying behavior. By identifying distinct customer groups, companies can tailor their marketing efforts to 
                      reach the most relevant prospects, resulting in higher conversion rates and improved customer loyalty.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      We provide tools to monitor and analyze marketing campaigns in real-time. Through continuous tracking and testing, businesses can optimize their strategies, ensuring that resources are allocated effectively, and campaigns yield the best possible results. 
                      This leads to enhanced performance and greater return on marketing investments. 
                      </p>
                    </div>
                  </div>
                </div>
