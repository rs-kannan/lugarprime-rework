        ...
        <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
          ...
          <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              Affiliate marketing is a performance-based marketing model where individuals or companies (affiliates) earn a commission by promoting products or services of a business and driving sales through their unique affiliate links.
               It's a cost-effective way for companies to expand reach and for affiliates to monetize their platforms.
              </p>
              <div className="mt-12 space-y-12">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    Affiliates join a program, receive unique tracking links, and promote products via blogs, social media, or ads. When a consumer clicks the link and makes a purchase, the affiliate earns a commission. 
                    This process leverages the affiliate’s influence and the brand’s offerings for mutual benefit.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    Businesses pay only for results, reducing marketing costs. Affiliates help expand the brand's visibility, tap into new markets, and drive sales without upfront advertising expenses. 
                    It’s a scalable, low-risk model for business growth.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    Affiliates earn passive income by monetizing their existing platforms. They don't need to create products or handle logistics, making it accessible. Successful affiliates can turn their
                     efforts into a significant revenue stream by selecting high-quality products and strategic marketing methods.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div>
            <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
              <div className="lg:col-start-2">
                ...
                <p className="mt-3 text-lg text-gray-600">
                Our Affiliate Marketing solutions empower brands to expand their reach, boost revenue, and 
                drive customer acquisition through strategic partnerships with trusted affiliates.
                ...
                <div className="mt-12 space-y-12">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      We connect brands with high-performing affiliates who align with their target audience, creating mutually beneficial relationships. This drives sales and brand awareness,
                       while affiliates earn commissions based on performance, ensuring a steady growth model for both parties.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Our affiliate marketing model focuses on performance-based compensation, meaning brands only pay for actual conversions, making it a cost-effective solution. 
                      This pay-per-action structure maximizes ROI while ensuring that marketing efforts are aligned with measurable results.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      We provide comprehensive tracking and analytics to measure the success of affiliate campaigns. By using real-time data, brands can optimize strategies, refine targeting, and make informed
                       decisions to enhance overall performance and achieve sustained growth in the competitive digital landscape. 
                      </p>
                    </div>
                  </div>
                </div>
