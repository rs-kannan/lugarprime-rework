...
function Socialmediaclick() {
  return (
    <div className='py-20'>
      <section>
     <div
      className="relative h-screen flex items-center justify-center bg-cover bg-center"
      style={{ backgroundImage: `url(${"https://t3.ftcdn.net/jpg/03/89/32/80/360_F_389328016_ak3iUrk15slWfEZdYL96O6eKTUyImDeC.jpg"})` }}
    >
        ...
        <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
          ...
          <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              Social Media Marketing (SMM) is the use of social media platforms to promote products, services, or brands. 
              It involves creating and sharing content to engage with audiences, build brand awareness, 
              and drive traffic or sales through social media channels like Facebook, Instagram, and Twitter.
              </p>
              <div className="mt-12 space-y-12">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    Social media marketing focuses on creating meaningful interactions with an audience. By posting relevant, valuable content and responding to comments,
                     businesses can foster customer relationships. Engaging with followers builds trust, loyalty, and a community 
                     around the brand, making it easier to convert followers into customers.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    Social media provides an excellent opportunity for businesses to increase brand recognition. Consistent posting and targeted ads on platforms like Instagram 
                    or Facebook help businesses reach a wide audience. Engaging visuals, user-generated content, and
                     shareable posts contribute to higher visibility and a broader audience reach.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    Social media platforms offer in-depth analytics that helps businesses track performance and understand audience behavior. 
                    By analyzing engagement metrics, such as likes, shares, and comments, businesses can refine their strategy. 
                    Data-driven insights help optimize future campaigns, leading to better outcomes and return on investment.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div aria-hidden="true" className="mt-10 lg:mt-0">
              <img
                src="https://img.freepik.com/free-vector/3d-social-media-icons-background_52683-28863.jpg"
                alt=""
          ...
          <div>
            <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
              <div className="lg:col-start-2">
                ...
                <p className="mt-3 text-lg text-gray-600">
                Our Social Media Marketing solutions empower businesses to build brand awareness, engage with their 
                target audience, and drive measurable growth through data-driven strategies tailored to your goals.
                ...
                <div className="mt-12 space-y-12">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      We design personalized campaigns that resonate with your audience, using advanced analytics to pinpoint demographics, preferences, and behaviors. 
                      This ensures optimized reach and engagement across platforms like Facebook, Instagram, and LinkedIn.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Our team crafts compelling visuals, videos, and copy tailored to your brand identity. We focus on fostering meaningful connections,
                       enhancing your online presence, and building trust through consistent and relatable storytellin
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Using real-time data, we monitor campaign effectiveness and implement agile adjustments to maximize ROI. 
                      Our reports offer actionable insights, 
                      keeping you informed and ensuring your social media efforts are always aligned with your business objectives.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
                <img
                  src="https://indylogix.com/wp-content/uploads/2024/03/cost-effective-roi.webp"
                  alt=""
                  className="mx-auto rounded-lg shadow-lg bg-gray-500"
                />
              </div>
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      {/* five start here */}  <div className="py-20"></div>
 <section>
...
<dl className="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-4 lg:gap-x-8">
 <div className="flex">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Content Sharing</dt>
     <dd className="mt-2 text-gray-600">Share multimedia content like videos, images, and blogs to engage audiences and boost brand visibility.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Targeted Advertising</dt>
     <dd className="mt-2 text-gray-600">Run ads targeting specific demographics, interests, or behaviors for precise audience engagement.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     ...
     <dd className="mt-2 text-gray-600">Foster relationships through comments, likes, and discussions, creating a loyal audience base.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Analytics</dt>
     <dd className="mt-2 text-gray-600">Track campaign performance metrics like reach, clicks, and conversions to optimize strategies.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Influencer Partnerships</dt>
     <dd className="mt-2 text-gray-600">Collaborate with influencers to promote products/services, leveraging their audience for brand exposure.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Real-Time Updates</dt>
     <dd className="mt-2 text-gray-600">Deliver timely updates on products, events, and trends to keep followers informed.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Cost-Effective Campaigns</dt>
     <dd className="mt-2 text-gray-600">Utilize affordable advertising options compared to traditional marketing methods.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Brand Building</dt>
     <dd className="mt-2 text-gray-600">Establish and reinforce brand identity through consistent messaging and creative content.</dd>
   </div>
 </div>
</dl>
</div>
...
export default Socialmediaclick
