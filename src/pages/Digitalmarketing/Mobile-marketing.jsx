  ...
  return (
    <div className='py-20'>
     ...
     <div
      ...
      style={{ backgroundImage: `url(${"https://png.pngtree.com/thumb_back/fh260/background/20230701/pngtree-dynamic-3d-mobile-mockup-social-media-web-development-and-marketing-materials-image_3701739.jpg"})` }}
    >
          ...
          <div className="grid gap-16 md:grid-cols-2 md:gap-4 lg:grid-cols-[1fr_340px_1fr]">
            ...
            <div className="flex flex-col items-start gap-16 [grid-area:2/1/3/3] md:gap-24 md:[grid-area:1/2/2/3] lg:[grid-area:1/3/4/4]">
              <div className="flex flex-col gap-4 md:items-end">
                ...
                <h3 className="text-2xl font-bold md:text-right md:text-3xl text-blue-800">
        ...
        <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
          ...
          <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              Mobile marketing involves promoting products or services through mobile devices, leveraging channels such as SMS, apps, mobile websites, 
              and social media to engage users directly and effectively. It focuses on creating personalized, 
              location-based, and interactive experiences for audiences on their smartphones or tablets.
              </p>
              <div className="mt-12 space-y-12">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    Mobile marketing allows businesses to deliver highly personalized messages tailored to user preferences, behavior, and location.
                     By using customer data, brands can send relevant offers, notifications, and recommendations, enhancing user satisfaction and fostering brand loyalty.
                      This approach ensures customers feel valued and connected to the brand.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    Mobile marketing supports instant communication, enabling brands to interact with users in real-time.
                     Features like push notifications, live chats, and location-based alerts ensure timely updates. 
                     This immediacy enhances customer engagement, encourages quick decision-making, and builds stronger relationships through consistent and direct communication.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    With billions of smartphone users worldwide, mobile marketing offers a vast and accessible audience.
                     Campaigns via SMS, in-app ads, or social media are relatively cost-effective compared to traditional media. 
                     Its scalability makes it suitable for small and large businesses to target and convert customers efficiently.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div aria-hidden="true" className="mt-10 lg:mt-0">
              <img
                src="https://img.freepik.com/free-vector/social-media-marketing-mobile-phone-concept_23-2148423442.jpg"
                alt=""
          ...
          <div>
            <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
              <div className="lg:col-start-2">
                ...
                <p className="mt-3 text-lg text-gray-600">
                Our mobile marketing solutions leverage cutting-edge technology and 
                data-driven strategies to enhance brand visibility, drive customer engagement, and 
                boost conversions across mobile platforms.
                ...
                <div className="mt-12 space-y-12">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Deliver targeted ads and messages using advanced audience segmentation to ensure relevance. 
                      Leverage AI-driven insights to optimize timing and content, improving engagement rates and ROI
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Seamlessly integrate campaigns across SMS, in-app notifications, and social media to create a cohesive customer experience. 
                      Synchronize data for consistent messaging and higher customer retention.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Track real-time campaign performance with comprehensive dashboards. 
                      Gain actionable insights into user behavior, optimize strategies, and measure success with precise KPIs. 
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
                <img
                  src="https://img.freepik.com/free-vector/social-media-marketing-mobile-phone-concept_23-2148421522.jpg"
                  alt=""
                  className="mx-auto rounded-lg shadow-lg bg-gray-500"
                />
              </div>
...
<div className="max-w-3xl mx-auto text-center">
 <h2 className="text-3xl font-extrabold sm:text-4xl">Features of Mobile Marketing</h2>
...
<dl className="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-4 lg:gap-x-8">
 <div className="flex">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Personalization</dt>
     <dd className="mt-2 text-gray-600">Tailors messages to individual users for higher engagement and relevance.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Location-based Targeting</dt>
     <dd className="mt-2 text-gray-600">Uses geolocation to send contextual offers.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">SMS Campaigns</dt>
     <dd className="mt-2 text-gray-600">Delivers concise, high-impact promotional messages.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">App Marketing</dt>
     <dd className="mt-2 text-gray-600">Boosts app downloads and user retention.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Push Notifications</dt>
     <dd className="mt-2 text-gray-600">Drives real-time updates or offers.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Social Media Ads</dt>
     <dd className="mt-2 text-gray-600">Targets mobile users on platforms.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Mobile-friendly Websites</dt>
     <dd className="mt-2 text-gray-600">Enhances usability for seamless browsing.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">QR Codes</dt>
     <dd className="mt-2 text-gray-600">Connects offline and online campaigns easily.</dd>
   </div>
 </div>
</dl>
</div>
