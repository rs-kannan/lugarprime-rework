  ...
  return (
    <div className='py-20'>
     ...
     <div
      ...
      style={{ backgroundImage: `url(${"https://www.redfishgroup.co.uk/wp-content/uploads/2020/06/bluebg.jpg"})` }}
    >
        ...
        <div className="mx-auto w-full max-w-7xl px-5 py-16 md:py-20">
          ...
          <div className="grid gap-16 md:grid-cols-2 md:gap-4 lg:grid-cols-[1fr_340px_1fr]">
            ...
            <div className="flex flex-col items-start gap-16 [grid-area:2/1/3/3] md:gap-24 md:[grid-area:1/2/2/3] lg:[grid-area:1/3/4/4]">
              <div className="flex flex-col gap-4 md:items-end">
              ...
              </div><div className="flex flex-col gap-4 md:items-end">
                <div className="flex items-center gap-4 md:flex-row-reverse">
                  <div className="rounded-full bg-gray-100 p-2.5">
                    <svg
                      width="26"
                ...
                <h3 className="text-2xl font-bold md:text-right md:text-3xl text-red-500">
                  <link rel="" type="" href="/services/digital-marketing/mobile-marketing"/>
                  Mobile Marketing.
                </h3>
              </div>
              <div className="flex flex-col gap-4 md:items-end">
        ...
        <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
          ...
          <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              Content Marketing is a strategy focused on creating and sharing valuable, relevant, and consistent content to attract and engage a target audience.
               The goal is to drive profitable customer actions, such as increasing brand awareness, fostering trust, and boosting conversions.
              </p>
              <div className="mt-12 space-y-12">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    Content marketing helps establish a brand as an authority in its industry by providing useful, informative content. 
                    By offering insights, solutions, or entertaining material, businesses build trust with their audience.
                     Over time, consumers rely on the brand for valuable information, leading to stronger customer loyalty and long-term relationships.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    Well-crafted content, such as blog posts, videos, and infographics, attracts potential customers by addressing their needs or interests. 
                    By optimizing content for search engines and sharing it on social platforms, businesses can reach a larger audience. Engaging content encourages interaction, such as comments, shares, and feedback, 
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    Content marketing not only attracts visitors but also converts them into leads or customers.
                     High-quality content with clear calls-to-action (CTAs) can guide consumers along their buying journey. 
                     By addressing pain points and offering solutions through content, businesses increase their chances of generating sales or inquiries.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div>
            <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
              <div className="lg:col-start-2">
                ...
                <p className="mt-3 text-lg text-gray-600">
                Our content marketing solutions are designed to engage your audience, build brand authority, and drive meaningful conversions. 
                Through strategic planning, high-quality content creation, and multi-channel distribution, we ensure your message
                ...
                <div className="mt-12 space-y-12">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      We identify your target audience, analyze market trends, and create a content strategy tailored to your goals. By aligning with your brand’s voice and values,
                       we ensure every piece of content resonates with your audience and supports measurable business outcomes.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Our team develops engaging, SEO-optimized content, including blogs, videos, infographics, and more.
                      We focus on storytelling, data-driven insights, and creativity to establish your brand as an industry leader while providing real value to your customers.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      We amplify your content’s reach through the right channels, including social media, email marketing, and partnerships. 
                      Our approach ensures maximum visibility, enhances audience engagement, and drives organic traffic, 
                      helping you achieve your business objectives efficiently.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
                <img
                  src="https://images.javatpoint.com/blog/images/content-marketing-goals.png"
                  alt=""
                  className="mx-auto rounded-lg shadow-lg bg-gray-500"
                />
              </div>
...
<div className="max-w-3xl mx-auto text-center">
 <h2 className="text-3xl font-extrabold sm:text-4xl">Features of Content Marketing</h2>
...
<dl className="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-4 lg:gap-x-8">
 <div className="flex">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Target Audience Focus     </dt>
     <dd className="mt-2 text-gray-600">Tailors content to meet specific audience needs, ensuring relevance and engagement.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Value-driven Content</dt>
     <dd className="mt-2 text-gray-600">Prioritizes informative, entertaining, or helpful content over promotional messaging to build trust and authority.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Consistency</dt>
     <dd className="mt-2 text-gray-600">Requires regular content publishing to maintain audience interest and improve search engine rankings.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     ...
     <dd className="mt-2 text-gray-600">Aligns content with search engine algorithms to enhance visibility and drive organic traffic.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Multi-Channel Approach</dt>
     <dd className="mt-2 text-gray-600">Distributes content across platforms like blogs, social media, and email to maximize reach.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Call-to-Action (CTA)</dt>
     <dd className="mt-2 text-gray-600">Incorporates clear CTAs to guide audience towards desired actions, like purchases or subscriptions.
 ...
 <div className="flex">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Performance Metrics:</dt>
     <dd className="mt-2 text-gray-600">Measures success through analytics, evaluating reach, engagement, and conversion rates for continuous improvement.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Story Telling</dt>
     <dd className="mt-2 text-gray-600">Engages audience emotionally through compelling narratives, making brands memorable and relatable.</dd>
   </div>
 </div>
</dl>
</div>
