...
import BgImage from"../../assets/LP-Site-Asste-IT-BG.png"
...
function Seo() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-white bg-opacity-10"></div> {/* Dark overlay */}
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-blue-800 z-10 text-center">
        Search Engine Optimization <span className='text-red-500'>(SEO)</span>
      </h1>
    </div>
     </section>
