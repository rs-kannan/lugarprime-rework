        ...
        <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
          ...
          <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              Email marketing is a digital strategy that involves sending emails to promote products, services, or content, 
              and build relationships with customers or prospects.
              </p>
              <div className="mt-12 space-y-12">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    Email marketing allows businesses to tailor content for specific audiences. By segmenting email lists based on customer behavior, preferences,
                    or demographics, companies can deliver targeted and relevant messages, increasing engagement and conversion rates.
                    </p>
                  </div>
                </div>
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    Compared to traditional advertising, email marketing is affordable and provides measurable results.
                     Marketers can track open rates, click-through rates, and conversions, enabling them to optimize campaigns and
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">
                    Emails keep customers informed about updates, promotions, and new offerings. 
                    Consistent communication fosters trust, loyalty, and repeat business, making it an essential tool for long-term customer retention and brand building.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div>
            <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
              <div className="lg:col-start-2">
                ...
                <p className="mt-3 text-lg text-gray-600">
                Boost customer engagement and drive conversions with our tailored email marketing solutions, 
                designed to deliver the right message to the right audience at the right time, enhancing brand loyalty 
                and sales growth.
                ...
                <div className="mt-12 space-y-12">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Leverage advanced segmentation to create tailored email content that resonates with individual customer preferences.
                       This ensures higher open rates, click-through rates, and meaningful engagement with your audience.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Automate your email workflows for efficiency and use robust analytics to track performance. 
                      Understand customer behaviors, refine strategies, and maximize ROI with actionable insights.
                      </p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">
                      Stand out with visually appealing and compelling email designs.
                       Our team crafts persuasive copy and dynamic visuals to captivate your audience and reflect your brand identity effectively.
                      </p>
                    </div>
                  </div>
                </div>
...
<div className="max-w-3xl mx-auto text-center">
 <h2 className="text-3xl font-extrabold sm:text-4xl">Features of Email Marketing</h2>
...
<dl className="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-4 lg:gap-x-8">
 <div className="flex">
   ...
   <div className="ml-3">
     ...
     <dd className="mt-2 text-gray-600">Tailor emails to individual preferences for higher engagement and customer retention.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Automation</dt>
     <dd className="mt-2 text-gray-600">Schedule campaigns for efficiency and consistent communication.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Segmentation</dt>
     <dd className="mt-2 text-gray-600">Target specific audience groups for precise messaging and better results.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
 ...
 <div className="flex">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">A/B Testing</dt>
     <dd className="mt-2 text-gray-600">Experiment with different email elements to improve performance.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Mobile Optimization</dt>
     <dd className="mt-2 text-gray-600"> Design responsive emails for seamless mobile user experiences.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Dynamic Content</dt>
     <dd className="mt-2 text-gray-600">Include interactive elements for enhanced user engagement.</dd>
   </div>
 </div>
 <div className="flex">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-violet-400">
   ...
   <div className="ml-3">
     <dt className="text-lg font-medium">Cost-Effectiveness</dt>
     <dd className="mt-2 text-gray-600">Reach broad audiences affordably compared to traditional marketing channels.</dd>
   </div>
 </div>
</dl>
</div>
