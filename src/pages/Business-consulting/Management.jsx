            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-24">
              <div className="group sm:flex lg:items-start">
                <div className="mb-4 shrink-0 sm:mb-0 sm:mr-4">
                  {/* <img className="w-full rounded-md object-cover sm:size-32" src="/api/placeholder/400/320" alt="Investment Strategies" /> */}
                </div>
                <div>
              ...
              <div className="group sm:flex lg:items-start">
                <div className="mb-4 shrink-0 sm:mb-0 sm:mr-4">
                  {/* <img className="w-full rounded-md object-cover sm:size-32" src="/api/placeholder/400/320" alt="Retirement Planning" /> */}
                </div>
                <div>
          ...
          <div className="container flex flex-col items-center gap-16 lg:px-16">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
              <a href="#" className="flex flex-col overflow-clip rounded-xl border border-border">
                <div>
                  {/* <img src="/images/placeholders/money-management/budgeting.jpg" alt="Budgeting Basics" className="aspect-[16/9] h-full w-full object-cover object-center" /> */}
                </div>
              ...
              <a href="#" className="flex flex-col overflow-clip rounded-xl border border-border">
                <div>
                  {/* <img src="/images/placeholders/money-management/investing.jpg" alt="Investing Tips" className="aspect-[16/9] h-full w-full object-cover object-center" /> */}
                </div>
                <div className="px-6 py-8 md:px-8 md:py-10 lg:px-10 lg:py-12">
                  <h3 className="mb-3 text-lg font-semibold md:mb-4 md:text-xl lg:mb-6">
              ...
              <a href="#" className="flex flex-col overflow-clip rounded-xl border border-border">
                <div>
                  {/* <img src="/images/placeholders/money-management/saving.jpg" alt="Saving Tips" className="aspect-[16/9] h-full w-full object-cover object-center" /> */}
                </div>
                <div className="px-6 py-8 md:px-8 md:py-10 lg:px-10 lg:py-12">
                  <h3 className="mb-3 text-lg font-semibold md:mb-4 md:text-xl lg:mb-6">
